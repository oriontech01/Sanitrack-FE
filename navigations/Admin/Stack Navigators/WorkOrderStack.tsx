...
import SelectNewWorkOrder from "../../../screens/Admin/WorkOrder/Facility Work Order/SelectNewWorkOrder";
import FacilityTimerDetails from "../../../screens/Admin/WorkOrder/Facility Work Order/FacilityTimerDetails";
import AllFacilities from "../../../screens/Admin/WorkOrder/Facility Work Order/AllFacilities";
...
const WorkOrderStack = () => {
  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen
        component={SelectInspectorsWorkOrder}
        name="SelectInspectors"
      />
      <Stack.Screen
        component={FacilityRoomsList}
        name="SelectUnassignedRooms"
      />
      <Stack.Screen component={SelectCleanersWorkOrder} name="SelectCleaners" />
      <Stack.Screen component={SelectNewWorkOrder} name="SelectNewWorkOrder" />
      <Stack.Screen component={AllFacilities} name="AllFacilities" />
      ...
      <Stack.Screen
        component={FacilityTimerDetails}
        name="FacilityTimerDetails"
      />
