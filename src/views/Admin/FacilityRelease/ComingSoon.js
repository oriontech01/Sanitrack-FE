  ...
  return (
    <>
      <div className="flex justify-center items-center flex-col gap-y-10">
        <h1 className="text-xl lg:text-2xl font-bold">New Feature Under Construction</h1>
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100.001px" height="100px" viewBox="0 0 100 68">
          <g id="large">
            <path
            ...
            c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z"
              ...
              stroke="#3366FF"
            />{' '}
            <animateTransform begin="0s" dur="3s" type="rotate" from="0 31 37" to="360 31 37" repeatCount="indefinite"></animateTransform>
          </g>
          <g id="small">
            <path
        ...
        <p className='text-lg text-center'>
          ...
          We are currently updating this feature.
        </p>
        <p>Its okay, we are excited too!</p>
      </div>
    </>
  );
};
