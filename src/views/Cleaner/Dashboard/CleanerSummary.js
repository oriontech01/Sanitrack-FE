    ...
    <>
      ...
      <div className="w-full lg:w-1/2 mt-5 fex flex-col space-y-3 ">
        ...
        <div className="flex flex-row justify-between items-center text-blue-500 font-semibold">
          <p>Clean Time</p>
          <span>{convertSecondsToHMS(timers ? timers?.clean_time : 0)}</span>
        </div>
        <div className="flex flex-row justify-between items-center text-blue-500 font-semibold">
          <p>Preop Time</p>
          <span>{convertSecondsToHMS(timers ? timers?.preOp_time : 0)}</span>
        </div>
        <div className="flex flex-row justify-between items-center text-blue-500 font-semibold">
          <p>Release Time</p>
          <span>{convertSecondsToHMS(timers ? timers?.release_time : 0)}</span>
        </div>
      </div>
