...
const useWorkHistory = () => {
  ...
  const getRoomHistory = async (roomId) => {
    ...
    try {
      const res = await axios.get(
        `${BASE_URL}work-history/rooms?roomId=${roomId}`,
        {
          headers: {
  ...
  const getInspectorHistory = async (inspectorId) => {
    try {
      const res = await axios.get(
        `${BASE_URL}work-history/inspector?inspectorId=${inspectorId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getCleanerHistory = async (cleanerId) => {
    try {
      const res = await axios.get(
        `${BASE_URL}work-history/cleaner?cleanerId=${cleanerId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getCleanerSummary = async () => {
    ...
    try {
      const res = await axios.get(
        `${BASE_URL}/work-history/cleaner-task-summary`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
